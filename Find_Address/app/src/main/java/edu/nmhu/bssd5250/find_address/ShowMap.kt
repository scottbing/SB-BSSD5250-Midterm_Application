...
import kotlinx.android.synthetic.main.show_map.*
...
class ShowMap : AppCompatActivity() {
    ...
    companion object{
        const val LOCATION_REQUESTED:String = "com.sbb5250.multipleactivities.LOCATION_REQUESTED"
    }

    private val TAG: String = ShowMap::class.java.simpleName
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        loc = intent.getStringExtra(LOCATION_REQUESTED)
        ...
        mapView.apply {
            ...
            onTouchListener = object : DefaultMapViewOnTouchListener(this@ShowMap, mapView) {
                    ...
                    if (newText.isNotEmpty()){
                        ...
                        suggestionsFuture.addDoneListener{
                            try {
                                ...
                                val suggestionAdapter = SimpleCursorAdapter(this@ShowMap,
